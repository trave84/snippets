...
gulp.task('develop', ['build'], function(){
    browserSync.init({ // initalize Browsersync
        ...
        proxy: {
            target: 'http://localhost:8000' // your other server is running here
        },
        port: 3060, // run Browsersync server on this port
        // specify which files' change should cause a reload
        files: [
            '**/*.php' // all php files in any folder (make it more specific for your case)
        ]
    });
